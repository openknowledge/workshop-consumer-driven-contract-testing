...
docker tag delivery-db localhost:5050/delivery-db:1.0.0
docker tag delivery-db localhost:5050/delivery-db:latest
docker push localhost:5050/delivery-db:1.0.0
docker push localhost:5050/delivery-db:latest
