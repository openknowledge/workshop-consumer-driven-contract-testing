...
public class CustomerMessageBodyReaderV1 implements MessageBodyReader<Customer> {
    ...
    public Customer readFrom(
        ...
        MessageBodyReader<CustomerV1> jsonReader = providers.getMessageBodyReader(
                CustomerV1.class,
                CustomerV1.class,
                annotations,
