...
public class CustomerMessageBodyReader implements MessageBodyReader<Customer> {
    ...
    @Override
    public Customer readFrom(Class<Customer> type, Type genericType, Annotation[] annotations,
            MediaType mediaType, MultivaluedMap<String, String> httpHeaders, InputStream entityStream)
            throws IOException, WebApplicationException {

        MessageBodyReader<Customer> jsonReader = providers.getMessageBodyReader(Customer.class,
                Customer.class, addDefaultAnnotation(annotations), MediaType.APPLICATION_JSON_TYPE);

        return jsonReader.readFrom(Customer.class, Customer.class, annotations,
